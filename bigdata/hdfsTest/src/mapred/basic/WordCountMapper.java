...
//Mapper - 데이터를 분류하는 역할
//1. Mapper클래스를 상속한다.
// => mapper에 전달될 input 데이터의 key, value타입과
//	  mapper의 결과로 출력되는 output 데이터의 key, value타입을 정의
...
// context-> 맵리듀스 작업을 수행하며 맵메소드의 실행결과 즉, 출력데이터를 기록하고 shuffle하고 리듀서로 내보내는 작업을 수행하는 객체
// 			프레임워크 내부에서 머신들끼리 통신할 때 필요한 여러가지 정보를 갖고 있다.
